      ...
      <nav className="fixed top-0 w-full z-20 shadow-lg lg:shadow-none bg-white">
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
          <div className="col-span-2 lg:hidden flex justify-items-stretch	 items-center">
            <svg
              ...
              className="col-span-1 lg:hidden w-8 h-8 cursor-pointer text-purple-600"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            ...
            <span
              ...
              className="flex items-left text-center font-bold uppercase text-gray-800 text-2xl heading-color-fix cursor-pointer px-2 text-center"
            >
              ChoChi
            </span>
          </div>
          ...
          <div className="hidden lg:block col-span-1 flex text-gray-600 mt-1">
            <span
              className="hover:bg-gray-200 px-4 py-3 rounded-lg font-light tracking-widest hover:text-gray-800 menu-color-fix cursor-pointer"
            ...
            {/* <span
              className="hover:bg-gray-200 px-4 py-3 rounded-lg font-light tracking-widest hover:text-gray-800 menu-color-fix cursor-pointer"
              onClick={(e) => history.push("/benefits")}
            >
              Benefits
            </span> */}
            <span
          ...
          <div
            ...
            className="hidden lg:block flex items-left col-span-1 text-center text-purple-800 font-bold tracking-widest uppercase text-2xl heading-color-fix cursor-pointer"
          >
            ChoChi
          </div>
          <div className="flex items-right col-span-2 lg:col-span-1 flex justify-end">
            ...
            <div
              ...
              className="hover:bg-gray-200 rounded-lg px-2 py-2 cursor-pointer menu-color-fix"
              title="Wishlist"
            >
              <svg
                className={`${
                  location.pathname === "/wish-list"
                    ? "fill-current text-gray-800 menu-color-fix"
                    : ""
                } w-8 h-8 text-gray-600 menu-color-fix cursor-pointer`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
            ...
            {localStorage.getItem("jwt") ? (
              <Fragment>
                ...
                >
                  <svg
                    className="cursor-pointer w-8 h-8 text-gray-600 hover:text-gray-800 menu-color-fix"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              >
                <svg
                  className="w-8 h-8 text-gray-600 hover:text-gray-800 menu-color-fix"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <div className="col-span-1 flex flex-col text-gray-600">
            <span
              className="font-medium text-lg tracking-widest hover:text-gray-800 menu-color-fix hover:bg-gray-200 px-3 py-2 rounded-lg cursor-pointer"
              onClick={(e) => history.push("/")}
            >
              Home
            </span>
