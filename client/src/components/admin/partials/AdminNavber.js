    ...
    <Fragment>
      <nav className="sticky z-10 flex items-center shadow-md justify-between px-4 py-4 md:px-8 top-0 w-full bg-white">
        ...
        <div className="hidden lg:block lg:flex lg:items-center lg:space-x-4 mr-32">
          <span>
            <svg
              className="w-8 h-8 cursor-pointer text-gray-600 menu-color-fix"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
        ...
        <div className="hidden lg:block">
          <span
            ...
            className="flex items-left text-center font-bold heading-color-fix uppercase text-gray-800 text-2xl cursor-pointer px-2 text-center"
          >
            ChoChi
          </span>
        </div>
        ...
        <div className="lg:hidden flex items-center">
          <svg
            id="hamburgerBtn"
            className="lg:hidden w-8 h-8 cursor-pointer text-gray-600 menu-color-fix"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="flex items-center">
          {/* <div className="hover:bg-gray-200 rounded-lg p-2" title="Search">
            <svg
              className="cursor-pointer w-8 h-8 text-gray-600 menu-color-fix hover:text-gray-800"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
